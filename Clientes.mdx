...
<Steps>
  <Step title="Preencha as informações Gerais da Propriedade">
    - Insira o **Nome** da propriedade.
    - Marque "**Inscrição Estadual Isento**" se for o caso, ou informe a **"Inscrição Estadual"**.
    - Preencha os campos : **Cód. Ref**. , **"Matrículas"**, **"Área"** e **"Descrição do Roteiro"**.
      <img
      src="cadastrar-propriedade-1.png"
      alt="Informações Gerais da Propriedade"
      height="300"
      className="rounded-lg"
      />
  </Step>
  <Step title="Preencha o Endereço da Propriedade">
    - Informe o **Endereço** completo da propriedade.
    - Selecione  o **Estado** e a **Cidade** correspondentes.
      <img
      src="cadastrar-propriedade-2.png"
      alt="Endereço da Propriedade"
      height="300"
      className="rounded-lg"
       />
  </Step>
  <Step title="Configure a Geolocalização da Propriedade">
    - Você pode inserir a **Latitude** e **Longitude** manualmente.
    - Alternativamente, utilize o **mapa interativo**:
      - Digite o nome da região ou cidade no campo de pesquisa do mapa e arraste o marcador verde para a localização exata.
      - Ou clique em **"Pesquisar sua localização aqui"** para usar a localização atual.
        <img
          src="cadastrar-propriedade-3.png"
          alt="Geolocalização da Propriedade"
          height="300"
          className="rounded-lg"
        />
  </Step>
  <Step title='Após preencher todas as informações necessárias, clique em "Salvar Propriedade"'>
    O sistema registrará a nova propriedade vinculada ao cliente.
    <img
      src="salvar-propriedade.png"
      alt="Salvar Propriedade"
      height="300"
      className="rounded-lg"
    />
  </Step>
