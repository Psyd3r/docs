...
* **Gerente**: Mostra o gerente responsável pelo consultor. 
  <CardGroup cols={1}>
    <Card title="Status" icon="lock" horizontal>
      Representado por um ícone de cadeado, este componente permite **ativar** ou **desativar** um consultor. Apenas usuários com as permissões adequadas podem realizar esta ação.
    </Card>
  </CardGroup>
...
<CardGroup cols={3}>
  <Card title="Visualizar" icon="eye" horizontal>
    Exibe os detalhes do consultor em modo somente leitura.
  </Card>
  <Card title="Editar" icon="pencil" horizontal>
    Permite editar as informações do consultor.
  </Card>
  <Card title="Excluir" icon="trash" horizontal>
    Permite excluir o consultor do sistema.
  </Card>
</CardGroup>
